...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<PaginatedResponse<ReleaseForArtist>>> GetAllReleasesForArtistAsync(int id, CancellationToken cancellationToken = default)
    {
        return await connection.SendPagedRequest<ReleaseForArtist>(HttpMethod.Get, $"artists/{id}/releases", cancellationToken);
    }

    public async Task<ReleaseRating> GetReleaseRatingAsync(int id, CancellationToken cancellationToken = default)
    {
        return await connection.SendRequest<ReleaseRating>(HttpMethod.Get, $"releases/{id}/rating", cancellationToken);
    }

    public async Task<ReleaseRatingByUser> GetReleaseRatingByUserAsync(int id, string username, CancellationToken cancellationToken = default)
    {
        return await connection.SendRequest<ReleaseRatingByUser>(HttpMethod.Get, $"releases/{id}/rating/{username}", cancellationToken);
    }
    ...
    public async Task<ReleaseRatingByUser> DeleteReleaseRatingByUserAsync(int id, string username, CancellationToken cancellationToken = default)
    => await connection.SendRequest<ReleaseRatingByUser>(HttpMethod.Delete, $"releases/{id}/rating/{username}", cancellationToken);

    public async Task<Master> GetMasterAsync(int id, CancellationToken cancellationToken = default)
    {
        return await connection.SendRequest<Master>(HttpMethod.Get, $"masters/{id}", cancellationToken);
    }
